...
class MemberExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('exams_count')->counts('exams'),
            ExportColumn::make('time_taken'),
            ExportColumn::make('successful_attempts'),
            ExportColumn::make('failed_attempts'),
            ExportColumn::make('total_attempts'),
